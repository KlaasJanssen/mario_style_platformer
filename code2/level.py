                ...
                if val != '-1':
                    ...
                    if type == 'coins':
                        if val == "0":
                            ...
                            coin_type = 'silver'
                        sprite = Coin(tile_size, x, y, '../graphics/coins/' + coin_type)

                    if type == 'fg_palms':
                        if val == "0":
                            palm_type, offset = 'small', 38
                        elif val == "1":
                            palm_type, offset = 'large', 70

                        sprite = Palm(tile_size, x, y, '../graphics/terrain/palm_' + palm_type, 70)
